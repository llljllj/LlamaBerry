#############################################################################
# Makefile for building: ollama_qt
# Generated by qmake (3.1) (Qt 5.15.8)
# Project:  ollama.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile ollama.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++17 -I/usr/include/python3.11 -I/usr/include/python3.11 -O2 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I/usr/include/aarch64-linux-gnu/qt5 -I/usr/include/aarch64-linux-gnu/qt5/QtWidgets -I/usr/include/aarch64-linux-gnu/qt5/QtGui -I/usr/include/aarch64-linux-gnu/qt5/QtNetwork -I/usr/include/aarch64-linux-gnu/qt5/QtCore -I. -I/usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ollama_qt1.0.0
DISTDIR = /home/lllj/Desktop/ollama_qt_cpp/LlamaBerry/.tmp/ollama_qt1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/lib/python3.11/config-3.11-aarch64-linux-gnu -L/usr/lib/aarch64-linux-gnu -ldl -lm /usr/lib/aarch64-linux-gnu/libQt5Widgets.so /usr/lib/aarch64-linux-gnu/libQt5Gui.so /usr/lib/aarch64-linux-gnu/libQt5Network.so /usr/lib/aarch64-linux-gnu/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		ollama.pro ollama.h main.cpp \
		ollama.cpp
QMAKE_TARGET  = ollama_qt
DESTDIR       = 
TARGET        = ollama_qt
...
Makefile: ollama.pro /usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/aarch64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ollama.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp ollama.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++17 -I/usr/include/python3.11 -I/usr/include/python3.11 -O2 -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/aarch64-linux-gnu/qt5/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_ollama.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ollama.cpp
moc_ollama.cpp: ollama.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/lllj/Desktop/ollama_qt_cpp/LlamaBerry/moc_predefs.h -I/usr/lib/aarch64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/lllj/Desktop/ollama_qt_cpp/LlamaBerry -I/usr/include/aarch64-linux-gnu/qt5 -I/usr/include/aarch64-linux-gnu/qt5/QtWidgets -I/usr/include/aarch64-linux-gnu/qt5/QtGui -I/usr/include/aarch64-linux-gnu/qt5/QtNetwork -I/usr/include/aarch64-linux-gnu/qt5/QtCore -I/usr/include/c++/12 -I/usr/include/aarch64-linux-gnu/c++/12 -I/usr/include/c++/12/backward -I/usr/lib/gcc/aarch64-linux-gnu/12/include -I/usr/local/include -I/usr/include/aarch64-linux-gnu -I/usr/include ollama.h -o moc_ollama.cpp
...
main.o: main.cpp ollama.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

ollama.o: ollama.cpp ollama.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ollama.o ollama.cpp

moc_ollama.o: moc_ollama.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ollama.o moc_ollama.cpp
